 ...
 * <li>{@link #openFile(Message, boolean)}</li>
...
public abstract class BaseFileWriter {
	...
	public abstract void openFile(Message message, boolean append) throws IOException;

	protected void openWriter(Message message, boolean append) throws IOException {
	...
	protected abstract File getMBoxFile(Message message);
	...
	protected abstract void writeMIME(Writer mbox, Message message, Iterator<String> mime) throws IOException;//FIXME replace BaseINotesMessage with "extraHeaders"?
